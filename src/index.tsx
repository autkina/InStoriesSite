...
const MainApp: React.FC = () => {
    ...
    return (
      ...
      <AppShell.Navbar p="md" style={{gap: "50px", backgroundColor: '#161519', marginTop: '50px'}}>
        <Button className="PersOpenButton" onClick={() => setCurrentComponent('pers1')} style={{margin: '5px'}}>Name of the character {'>'} </Button>
        <Button className="PersOpenButton" onClick={() => setCurrentComponent('pers2')} style={{margin: '5px'}}>Name of the character {'>'} </Button>
      </AppShell.Navbar>
